...
#   jami-commander.py and README.md have been separated,
#   i.e. jami-commander.py no longer contains the README portion

# - extract the README portion within the jami_commander.py file
